package mx.edu.utez.erielit.security.controller;

import mx.edu.utez.erielit.security.jwt.JwtProvider;
...
public class AuthController {
    ...
    public ResponseEntity<Message> login(@Valid @RequestBody LoginUserDTO loginUserDTO,
        ...
        if (result.hasErrors())
            return new ResponseEntity<>(new Message("Ingrese datos correctos", true, null),
